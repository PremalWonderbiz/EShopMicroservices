                    ...
                    <div className="order-detail-main">
                        ...
                        <Card className="timeline-card">
                            ...
                            <div className="order-timeline">
                                <div
                                    className={`timeline-step ${order.status >= OrderStatus.Pending ? 'timeline-step-completed' : ''
                                        }`}
                                >
                                ...
                                <div
                                    className={`timeline-step ${order.status >= OrderStatus.Pending ? 'timeline-step-active' : ''
                                ...
                                <div
                                    className={`timeline-step ${order.status === OrderStatus.Completed ? 'timeline-step-completed' : ''
                                        }`}
                                >
                                    <div className="timeline-marker">
